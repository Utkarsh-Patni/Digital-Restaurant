			...
			<div class="col s12 m4">
				<div class="card">
				    ...
				    <div class="card-content">
					  ...
					  <a class="black-text" href=""><?php echo $arr_all[$i+$j-2]['fname']; ?></a><i class="material-icons right">more_vert</i></span>		
				      <div class="card-content">
			          <p><?php echo "<b>Price: "; echo $arr_all[$i+$j-2]['price']; echo " Rs.<br><br></b>"; ?></p>
