<section class="ffooter">
		<footer class="page-footer" style="background-color: firebrick;">
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                <h5 class="white-text">Contact US</h5>
                <p class="grey-text text-lighten-4">Station Road, Near GECA, Osmanpoora, Aurangabad</p>
                <p class="grey-text text-lighten-4">Phone : +12-345-678-9000</p>
              </div>
