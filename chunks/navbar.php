<section class="fnavbar">
		...
		<nav style="background-color: firebrick;">
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">RestroDigital</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/RestroDigital" class="hvr-grow">Home</a></li>
		        <li><a href="/RestroDigital/about-restro-Digital.php" class="hvr-grow">About Us</a></li>
		        ...
		        <li><a href="Payment.php" class="hvr-grow">Bill Payment</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/RestroDigital">Home</a></li>
	        <li><a href="/RestroDigital/about-restro-Digital.php">About Us</a></li>
			...
			<li><a href="foods.php">Bill Payment</a></li>
